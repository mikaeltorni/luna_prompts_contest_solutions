...
| --- | --- | ---: | ---: | --- | --- |
| A1 | About description | 3 | 3 | gh repo view mikaeltorni/luna_prompts_contest_solutions --json description → exact definitional About sentence is present | — |
| A2 | Topics | 4 | 4 | gh repo view mikaeltorni/luna_prompts_contest_solutions --json repositoryTopics → 9 descriptive topics, including llm-evaluation and prompt-examples | — |
| A3 | Homepage URL | 2 | 0 | gh repo view mikaeltorni/luna_prompts_contest_solutions --json homepageUrl → empty | User-owned: set a truthful project homepage or published docs URL. |
...
| A5 | Social preview | 3 | 0 | gh repo view mikaeltorni/luna_prompts_contest_solutions --json usesCustomOpenGraphImage → false | User-owned: upload and select a custom social-preview image in GitHub settings. |
...
| B5 | Instant start | 2 | 2 | README.md:21-30 → clone plus solution-directory inventory gives an immediate reference result | — |
...
| D5 | Machine-readable metadata | 1 | 1 | CITATION.cff:1-12 → CFF 1.2.0 with abstract, author, repository-code, and dataset type | — |
| E1 | License | 2 | 2 | LICENSE and gh community profile → MIT License recognized remotely | — |
...
| H1 | Own-network cross-links | 3 | 3 | README.md → descriptive reciprocal links to prompt_challenge_generator | — |
...
| I1 | Activity | 2 | 2 | gh repo view mikaeltorni/luna_prompts_contest_solutions --json pushedAt → 2026-08-16T14:12:51Z; within the 90-day activity window | — |
...
| --- | --- | --- |
| Push the verified local default-branch commits | This workflow does not push to remotes. | git -C /home/mk/projects/luna_prompts_contest_solutions push origin master |
