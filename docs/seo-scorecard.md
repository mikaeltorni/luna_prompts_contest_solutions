# SEO Scorecard — luna_prompts_contest_solutions

- Canonical URL: <https://github.com/mikaeltorni/luna_prompts_contest_solutions>
- Round: 1   Date: 2026-08-27   Score: 20/100 (19.5/100 raw, 0 penalty)
- Verdict: in progress

## Keyword model
| Role | Terms | Why |
| --- | --- | --- |
| Primary | LunaPrompts contest solutions | Narrow query matching the repository's user-facing purpose. |
| Secondary | prompt engineering examples; token-efficient prompts; GPT-4.1 prompts; Kimi K2 prompts; few-shot prompting | Adjacent searches supported by the current project surface. |
| Long-tail | winning LunaPrompts prompt solutions; tested prompt engineering contest examples; token-efficient SQL prompts; prompt examples for classification; meeting-notes action extraction prompt; content moderation prompt | Specific problem phrasings the documentation can answer truthfully. |
| Confusable with | LunaPrompts website challenge pages; generic GPT prompt collections; unrelated prompt contests | Names and adjacent projects that require clear positioning. |

## Criteria
| ID | Criterion | Max | Score | Evidence | Gap / next action |
| --- | --- | ---: | ---: | --- | --- |
| A1 | About description | 3 | 3 | gh repo view mikaeltorni/luna_prompts_contest_solutions --json description → "Winning and podium LunaPrompts contest solutions — token-efficient GPT-4.1 and Kimi K2 prompt engineering references (learning aid)." | — |
| A2 | Topics | 4 | 2 | gh repo view mikaeltorni/luna_prompts_contest_solutions --json repositoryTopics → topics recorded in the remote audit | Add or verify this artifact in the next improvement round. |
| A3 | Homepage URL | 2 | 0 | gh repo view mikaeltorni/luna_prompts_contest_solutions --json homepageUrl → "" | Add or verify this artifact in the next improvement round. |
| A4 | Name fit | 3 | 2 | README.md:1 and repository name "luna_prompts_contest_solutions" | Add or verify this artifact in the next improvement round. |
| A5 | Social preview | 3 | 0 | gh repo view mikaeltorni/luna_prompts_contest_solutions --json usesCustomOpenGraphImage → false; only GitHub's generated preview URL is configured | Add or verify this artifact in the next improvement round. |
...
| C2 | Heading semantics | 3 | 0 | README.md headings → current heading levels and wording | Add or verify this artifact in the next improvement round. |
...
| E5 | Community Standards | 2 | 0 | gh api repos/mikaeltorni/luna_prompts_contest_solutions/community/profile → health checklist measured at 42% or unavailable | Add or verify this artifact in the next improvement round. |
...
| G1 | Published artifact | 3 | 0 | gh release list --repo mikaeltorni/luna_prompts_contest_solutions → no published release artifact | Add or verify this artifact in the next improvement round. |
...
| I1 | Activity | 2 | 2 | gh repo view ... --json pushedAt → 2026-08-16T14:12:51Z | — |
...
| --- | --- | ---: | --- |
| 1 | 2026-08-27 | 20/100 | Baseline audit recorded before this round's documentation and metadata changes. |
